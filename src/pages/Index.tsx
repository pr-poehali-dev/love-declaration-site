...
const feelings = [
  ...
  { emoji: "💍", title: "Моя невеста", text: "Ты моя невеста — и это самое красивое слово, которое я когда-либо произносил. Я хочу быть рядом с тобой всю жизнь." },
  { emoji: "🐻", title: "Моя буська", text: "Буська моя любимая — ты такая милая, что хочется тискать тебя без остановки и никуда не отпускать." },
  { emoji: "😤", title: "Злюка, но моя любимая", text: "Ты иногда злишься — и даже тогда ты самая красивая. Твоя злость только делает тебя роднее. Я люблю тебя и такой." },
